# Growth Operations Portfolio

这是我的增长运营作品集目录，用来集中展示方法论、模板、产品、工具和可复用工作流。

我更希望这些项目被理解成一组“认知仓库”，而不是一组普通代码仓库。它们的重点不是展示某个功能有多复杂，而是展示我如何把真实业务问题拆成判断框架、操作流程、数据口径和复盘机制。
...
| PickAiHub 免费 AI API 与统一接入工具 | AI 产品 / SEO 获客 / 用户激活 | 把免费模型搜索、供应商申请、个人 BYOK 连接和 OpenAI-compatible 统一 API 整理成完整用户路径 | [项目案例](case-studies/pickaihub.md) · [在线产品](https://pickaihub.com) · [代码仓库](https://github.com/The-AlexLiu/pickaihub) |
| AimCodes 多语种准星工具 | 0→1 产品 / SEO 工具站 | 从用户洞察出发，把准星发现、场景预览、互动推荐、多语种 SEO、数据追踪和内容自动化组合成可长期维护的增长产品 | [项目案例](case-studies/aimcodes.md) · [在线产品](https://aimcodes.com) · [代码仓库](https://github.com/The-AlexLiu/aimcodes) |
...
| Growth Data Reader Skill | 数据分析 / AI 自动化 | 用一个 Account Profile、统一只读 Gateway 和通用 Prompt 连接 GA4、GSC 与 Google Ads，可安装到飞书 Aily 与 WorkBuddy，并可迁移到其他品牌账户 | [项目仓库](https://github.com/The-AlexLiu/Growth-Data-Reader-Skill) · [下载安装包](https://github.com/The-AlexLiu/Growth-Data-Reader-Skill/releases/latest) |
...
3. 接着看 [AimCodes 多语种准星工具案例](case-studies/aimcodes.md)，了解我如何从用户需求、产品体验、SEO 内容架构、数据闭环到自动化运营，完成一个工具站的 0→1。
4. 再看 [PickAiHub 免费 AI API 与统一接入工具案例](case-studies/pickaihub.md)，了解我如何把 SEO 搜索意图、产品激活、个人账号接入与 API 服务组织成一条完整路径。
5. 然后看 [AimCodes 社媒素材渲染器](https://github.com/The-AlexLiu/AimCodes-Social-Creative-Renderer)，了解我如何把产品数据、多语种内容和平台规范转化成可批量生产的增长素材。
6. 接着看 [内容结构评分系统](https://github.com/The-AlexLiu/Creative-Content-Scoring-System)，了解我如何把主观素材判断拆成可复盘维度。
7. 再看 [落地页内容诊断方法](https://github.com/The-AlexLiu/Landing-Page-Diagnosis-Playbook)，了解我如何把投放入口、页面内容和用户任务串起来判断转化问题。
8. 接着看 [素材衰退管理方法](https://github.com/The-AlexLiu/Creative-Fatigue-Management-Playbook)，了解我如何管理素材生命周期和爆款依赖风险。
9. 再看 [Meta Ads 账户结构方法](https://github.com/The-AlexLiu/Meta-Ads-Account-Structure-Playbook) 和 [Google Ads 账户结构方法](https://github.com/The-AlexLiu/Google-Ads-Account-Structure-Playbook)，了解我如何把账户结构、素材测试和业务指标连接成投放系统。
10. 接着看 [Growth Data Reader Skill](https://github.com/The-AlexLiu/Growth-Data-Reader-Skill)，了解我如何用一个 Profile、统一权限边界和一段通用 Prompt，把 GA4、GSC、Google Ads 与 AI 工作台连接成可迁移的团队数据能力。
