...
9. 接着看 [Growth Data Reader Skill](https://github.com/The-AlexLiu/Growth-Data-Reader-Skill)，了解我如何用一个 Profile、统一权限边界和一段通用 Prompt，把 GA4、GSC、Google Ads 与 AI 工作台连接成可迁移的团队数据能力。
